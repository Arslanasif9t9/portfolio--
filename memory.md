...
- **Next:** owner creates admin account (first visit to login URL), tests panel. Remaining optional: widget-side notifications popups + feedback buttons + realtime admin replies in widget (end-user side of admin features). Remind owner to revoke Supabase access token when work is finished.
